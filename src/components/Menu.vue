  ...
  <div class="Menu">
    ...
    <div class="links">
      ...
      <div>
        ...
        <router-link v-if="path != 'Projects'" to="/Projects"
    ...
    <div class="footer">
      <div id="Mail">
        ...
        <hr />
        <p class="description">
          This button will open your default mail client with my email filled
          in. If you don't want to open it, then my email is
